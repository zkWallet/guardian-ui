...
export interface CountersInternalInterface extends utils.Interface {
  functions: {};
...
export interface CountersInternal extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CountersInternalInterface;
